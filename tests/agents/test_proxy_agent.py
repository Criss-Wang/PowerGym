...
class TestProxyAgentInitialization:
    ...
    def test_channel_setup(self):
        ...
        env_channel = ChannelManager.power_flow_result_channel("env_0", "proxy")
...
class TestNetworkStateReception:
    ...
    def test_receive_network_state_single_message(self):
        ...
        channel = ChannelManager.power_flow_result_channel("env_0", "proxy")
        state_payload = {
            "converged": True,
            "agents": {
...
class TestMultiEnvironmentIsolation:
    ...
    def test_multiple_proxies_different_environments(self):
        ...
        channel1 = ChannelManager.power_flow_result_channel("env_0", "proxy")
        msg1 = Message(
            env_id="env_0",
            sender_id="environment",
            recipient_id="proxy",
        ...
        channel2 = ChannelManager.power_flow_result_channel("env_1", "proxy")
        msg2 = Message(
            env_id="env_1",
            sender_id="environment",
            recipient_id="proxy",
