   ...
   <div class="container">
      <div class="row">
         <div class="col-md-6">
            ...
            <p>Understand agents, protocols, and coordination mechanisms.</p>
            <a href="../user_guide/basic_concepts.html">Core Concepts →</a>
         </div>
         <div class="col-md-6">
            <h4>🏗️ System Architecture</h4>
            <p>Explore the hierarchical agent architecture and message broker.</p>
