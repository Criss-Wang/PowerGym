        ...
        for i, config in enumerate(mg_configs):
            ...
            ess = ESS(
                ...
                device_config={
                    ...
                    "device_state_config": {
                        "bus": "Bus 634",
                        "capacity_MWh": ess_config["capacity"],
                        "max_e_MWh": ess_config["capacity"] * 0.9,
                        "min_e_MWh": ess_config["capacity"] * 0.1,
                        "max_p_MW": ess_config["p_max"],
                        "min_p_MW": -ess_config["p_max"],
                        "max_q_MVAr": ess_config["p_max"] * 0.4,
                        "min_q_MVAr": -ess_config["p_max"] * 0.4,
