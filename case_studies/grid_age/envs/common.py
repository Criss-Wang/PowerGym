"""Common utilities and classes shared across microgrid environments."""
...
class EnvState:
    ...
    def set_device_setpoint(self, device_id: str, P: float = 0.0, Q: float = 0.0) -> None:
        ...
        """
        self.device_setpoints[device_id] = {"P": P, "Q": Q}
